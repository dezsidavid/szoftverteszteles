...
public class HomePage {
    ...
    private static final Map<String, By> RemoveButtons = Map.of(
            "Sauce Labs Backpackremove", By.id("remove-sauce-labs-backpack"),
            "Sauce Labs Bike Lightremove", By.id("remove-sauce-labs-bike-light"),
            "Sauce Labs Bolt T-Shirtremove", By.id("remove-sauce-labs-bolt-t-shirt"),
            "Sauce Labs Fleece Jacketremove", By.id("remove-sauce-labs-fleece-jacket"),
            "Sauce Labs Onesieremove", By.id("remove-sauce-labs-onesie"),
